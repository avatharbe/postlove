...
$lang = array_merge($lang, array(
	...
	'NO_PERMISSION_TO_LIKE_POST' => 'нямате право да харесате тази публикация',
	...
	'POSTLOVE_HIDE' 			=> 'Скриване на бутона за харесване',
	'POSTLOVE_HIDE_EXPLAIN'	=> 'Скрива бутона за харесване на всяка публикация. Връзката „Харесвания“ в профила ви, броят на харесванията в списъка с теми и обобщенията на най-харесваните публикации се управляват отделно по-долу.',
	'POSTLOVE_HIDE_PROFILE'	=> 'Скриване на връзката и броячите „Харесвания“',
	'POSTLOVE_HIDE_PROFILE_EXPLAIN'	=> 'Скрива връзката „Харесвания“ в собствения ви профил, както и броя дадени/получени харесвания, показан на вашите публикации. Не засяга бутона за харесване.',
	'POSTLOVE_HIDE_TOPICS'	=> 'Скриване на броя на харесванията в списъка с теми',
	'POSTLOVE_HIDE_TOPICS_EXPLAIN'	=> 'Скрива броя на харесванията, показан до всяка тема в списъка с теми. Не засяга бутона за харесване на публикации.',
	'POSTLOVE_HIDE_SUM'	=> 'Скриване на панелите с най-харесваните публикации',
	'POSTLOVE_HIDE_SUM_EXPLAIN'	=> 'Скрива панелите с най-харесваните публикации от началната страница и форумите. Не засяга бутона за харесване на публикации.',
	...
	'NO_ACTIONS_FOUND'				=> 'Не са намерени харесвания.',
));
