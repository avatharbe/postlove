...
$lang = array_merge($lang, array(
	'POSTLOVE_USER_LIKES'	=> 'Likes given',
	'POSTLOVE_USER_LIKED'	=> 'Likes received',

	'NOTIFICATION_POSTLOVE_ADD'	=> '%s <b>liked</b> your post:',
	'NOTIFICATION_TYPE_POST_LOVE'	=> 'Liked posts.',

	// Ver 1.1
	'LOVELIST_LIKED'	=> 'liked',
	'LOVELIST_POST_OF'	=> '\'s post',
	'LOVELIST_IN_TOPIC'	=> 'in topic',
	'POSTLOVE_LIST'	=> 'Likes',
	...
	'POSTLOVE_HIDE_EXPLAIN'	=> 'Hides the like button on every post. Your profile\'s "Likes" link, the topic-list like count, and the most-liked-posts summaries are controlled separately, below.',
	'POSTLOVE_HIDE_PROFILE'	=> 'Hide your "Likes" link and counts',
	'POSTLOVE_HIDE_PROFILE_EXPLAIN'	=> 'Hides the "Likes" link on your own profile, and the likes given/received counts shown on your posts. Does not affect the like button.',
	'POSTLOVE_HIDE_TOPICS'	=> 'Hide the topic list like count',
	'POSTLOVE_HIDE_TOPICS_EXPLAIN'	=> 'Hides the like count shown next to each topic in the topic list. Does not affect the like button on posts.',
	'POSTLOVE_HIDE_SUM'	=> 'Hide most-liked-posts summaries',
	'POSTLOVE_HIDE_SUM_EXPLAIN'	=> 'Hides the most-liked-posts panels on the board index and forums. Does not affect the like button on posts.',
	...
	'NO_ACTIONS_FOUND'				=> 'No like actions found.',
));
