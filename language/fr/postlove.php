...
$lang = array_merge($lang, array(
	'POSTLOVE_USER_LIKES'	=> 'J\'aime donnés',
	...
	'POSTLOVE_HIDE_EXPLAIN'	=> 'Masque le bouton J\'aime sur chaque message. Le lien « J\'aime » sur votre profil, le nombre de J\'aime dans la liste des sujets et les panneaux des messages les plus aimés sont contrôlés séparément ci-dessous.',
	'POSTLOVE_HIDE_PROFILE'	=> 'Masquer votre lien et compteurs « J\'aime »',
	'POSTLOVE_HIDE_PROFILE_EXPLAIN'	=> 'Masque le lien « J\'aime » sur votre propre profil, ainsi que le nombre de J\'aime donnés/reçus affiché sur vos messages. N\'affecte pas le bouton J\'aime.',
	'POSTLOVE_HIDE_TOPICS'	=> 'Masquer le nombre de J\'aime dans la liste des sujets',
	'POSTLOVE_HIDE_TOPICS_EXPLAIN'	=> 'Masque le nombre de J\'aime affiché à côté de chaque sujet dans la liste des sujets. N\'affecte pas le bouton J\'aime sur les messages.',
	'POSTLOVE_HIDE_SUM'	=> 'Masquer les panneaux des messages les plus aimés',
	'POSTLOVE_HIDE_SUM_EXPLAIN'	=> 'Masque les panneaux des messages les plus aimés sur l\'index et les forums. N\'affecte pas le bouton J\'aime sur les messages.',
	...
	'NO_ACTIONS_FOUND'				=> 'Aucun J\'aime trouvé.',
));
