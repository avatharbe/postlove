...
$lang = array_merge($lang, array(
	...
	'POSTLOVE_HIDE_EXPLAIN'	=> 'Her gönderideki beğeni düğmesini gizler. Profilinizdeki "Beğeniler" bağlantısı, konu listesindeki beğeni sayısı ve en çok beğenilen gönderiler panelleri aşağıda ayrı olarak ayarlanır.',
	'POSTLOVE_HIDE_PROFILE'	=> '"Beğeniler" bağlantınızı ve sayaçlarınızı gizle',
	'POSTLOVE_HIDE_PROFILE_EXPLAIN'	=> 'Kendi profilinizdeki "Beğeniler" bağlantısını ve gönderilerinizde gösterilen verilen/alınan beğeni sayılarını gizler. Beğeni düğmesini etkilemez.',
	'POSTLOVE_HIDE_TOPICS'	=> 'Konu listesindeki beğeni sayısını gizle',
	'POSTLOVE_HIDE_TOPICS_EXPLAIN'	=> 'Konu listesinde her konunun yanında gösterilen beğeni sayısını gizler. Gönderilerdeki beğeni düğmesini etkilemez.',
	'POSTLOVE_HIDE_SUM'	=> 'En çok beğenilen gönderiler panellerini gizle',
	'POSTLOVE_HIDE_SUM_EXPLAIN'	=> 'En çok beğenilen gönderiler panellerini forum ana sayfasından ve forumlardan gizler. Gönderilerdeki beğeni düğmesini etkilemez.',
