...
/**
 * Version marker for release 2.2.3.
 *
 * Intentionally empty: 2.2.3 only fixed heart button styling in third-party
 * styles (#34) and changed no schema or data. The migration exists so the
